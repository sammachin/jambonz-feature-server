      ...
      if (req.locals.queue_name) {
        ...
        if (arr) {
          ...
          if (app) {
            ...
            let vcs = JSON.stringify(voip_carriers)
            logger.debug(`carriers: ${vcs}`)
            app = await lookupAppByPhoneNumber(req.locals.calledNumber, '2ab1b9bb-8f06-4272-a125-3a37a62c7ec5');
